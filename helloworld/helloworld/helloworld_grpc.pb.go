...
func (c *greeterClient) PingPong(ctx context.Context, opts ...grpc.CallOption) (Greeter_PingPongClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], "/helloworld.Greeter/PingPong", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterPingPongClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterPingPongClient) Recv() (*HelloReply, error) {
	m := new(HelloReply)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (UnimplementedGreeterServer) PingPong(Greeter_PingPongServer) error {
...
func (x *greeterPingPongServer) Send(m *HelloReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterPingPongServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
